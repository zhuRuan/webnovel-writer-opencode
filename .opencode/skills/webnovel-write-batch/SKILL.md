...
| 2 | 审查分数已计算 | review_metrics.json 存在 | 2.3 |
| 3 | **Data Agent 已回写** | state.json/index.db/summaries 更新 | 2.6 |
| 4 | **batch_state.json 已更新** | completed_chapters 包含当前章 | 2.8 |
| 5 | Git 提交已完成 | commit 存在 | 2.7 |
